...
@RequestMapping("/api/phase3/negociations/{negociationId}/messages")

public class MessageNegociationPhase3Controller {
    ...
    @PostMapping
    public ResponseEntity<MessageNegociation> envoyerMessagePhase3(
    ...
    @GetMapping
    public ResponseEntity<List<MessageNegociation>> listerMessagesPhase3(@PathVariable Long negociationId) {
